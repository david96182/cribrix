...
GOLDEN_CASES: list[GoldenCase] = [
    ...
    _u("What uptime does the SLA guarantee for Pro plan customers?", "near_miss",
    ...
    _u("How often are API keys rotated automatically?", "near_miss",
       "Manual rotation is described; no automatic schedule exists."),
